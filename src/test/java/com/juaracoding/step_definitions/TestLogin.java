...
public class TestLogin {
    ...
    public void user_enter_username_password_invalid() {
        login.loginPage();
        login.loginForm("rinjani1354@gmail.com", "rinjani34");
    ...
    public void user_invalid_credentials() {
        Assert.assertTrue(login.getTxtError().contains("ERROR"));
    ...
    public void user_valid_credentials() {
        Assert.assertEquals(login.getTxtMyAccount(), "Rinjani");
