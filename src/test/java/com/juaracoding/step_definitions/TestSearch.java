...
public class TestSearch {
    ...
    public void user_typing_sock_product_search() {
        search.searchItem("sock");
        extentTest.log(LogStatus.PASS, "User typing helm product in search");
    }

    @And("User click enter for product not found")
    public void user_click_enter_for_product_not_found() {
        search.pressEnter();
        extentTest.log(LogStatus.PASS, "User click enter for product not found");
    }
    ...
    public void user_press_enter() {
        search.pressEnter();
        extentTest.log(LogStatus.PASS, "User click enter");
    }
